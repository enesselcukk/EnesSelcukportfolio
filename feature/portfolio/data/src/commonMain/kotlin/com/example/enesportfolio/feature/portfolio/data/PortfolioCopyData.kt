...
internal object PortfolioCopyData {
  private val englishCopy = PortfolioCopy(
    ...
    aboutSec = "mTLS/TLS, biometrics, KYC, and NFC. R8 obfuscation and root detection. Room with SQLCipher, Android Keystore, EncryptedSharedPreferences (AES256-SIV, AES256-GCM), and MasterKey.",
  ...
  private val turkishCopy = PortfolioCopy(
    ...
    aboutSec = "mTLS/TLS, biometrics, KYC ve NFC. R8 obfuscation ve root detection. Room ve SQLCipher, Android Keystore, EncryptedSharedPreferences (AES256-SIV, AES256-GCM) ve MasterKey.",
    ...
    j1Team = "30+ kişilik bir takımda çalıştım.",
    ...
    j2Team = "15+ kişilik bir takımda çalıştık.",
