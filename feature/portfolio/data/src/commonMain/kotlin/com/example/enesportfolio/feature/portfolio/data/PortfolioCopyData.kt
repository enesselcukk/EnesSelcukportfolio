...
internal object PortfolioCopyData {
  ...
  private val turkishCopy = PortfolioCopy(
    ...
    heroRole = "Android Developer",
    heroLede =
      "Beş yılı aşkın süredir Kotlin ve Java ile canlıya çıkan Android uygulamaları ve bankacılık SDK'ları yazıyorum. Jetpack Compose'u Garanti BBVA'da günlük iş olarak kullandım. Migros İK, Hürriyet, Havaş ve İŞMER İntranet'te de çalıştım. Kotlin Multiplatform ile iş olarak ilgileniyorum; Compose Multiplatform'u kişisel projelerimde kullanıyorum.",
    downloadCv = "CV'yi indir",
    portraitCaption = "İstanbul, Türkiye",
    aboutTitle = "Uzmanlık",
    aboutBody =
      "MVI ve MVVM, sunucu güdümlü arayüz (SDUI), mobil güvenlik (mTLS/TLS, biyometri, KYC/NFC) ve çok modüllü yapı üzerinde çalışıyorum. Teslim ettiğim uygulamalarda CI/CD'yi, unit ve UI testlerini de ben kuruyorum.",
    ...
    j3a = "Üniversitenin resmi uygulamasını Kotlin, MVVM ve Firebase ile yazdım. Giriş ve kampüs haberlerini ekledim.",
